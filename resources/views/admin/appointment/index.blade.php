  ...
  <div class="overflow-x-auto rounded-2xl">
    ...
    <thead class="bg-slate-900 text-gold uppercase text-sm font-bold">
      <tr>
        ...
        <th class="p-4 text-xs font-bold">Customer</th>
        <th class="p-4 text-xs font-bold">Barber</th>
        <th class="p-4 text-xs font-bold">Layanan</th>
        <th class="p-4 text-xs font-bold">Tanggal</th>
        <th class="p-4 text-xs font-bold">Jam</th>
        <th class="p-4 text-xs font-bold">Status</th>
        <th class="p-4 text-xs font-bold">Aksi</th>
      </tr>
    </thead>
    <tbody class="divide-y divide-gray-700">
      ...
      <tr class="hover:bg-slate-700 transition">
        ...
        <td class="p-4">{{ $appointment->barber->name ?? '-' }}</td>
        <td class="p-4">{{ $appointment->service->name ?? '-' }}</td>
        <td class="p-4">{{ \Carbon\Carbon::parse($appointment->booking_date)->format('d M Y') }}</td>
        <td class="p-4">{{ $appointment->booking_time }}</td>
        <td class="p-4">
