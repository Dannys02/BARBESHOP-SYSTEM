...
<div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
    ...
    <div class="bg-slate-800/50 p-6 rounded-2xl border border-gray-700 hover:border-gold/50 transition-all duration-300 group">
      ...
      <div class="flex items-baseline gap-2">
        ...
        <p class="text-xs text-gold font-medium uppercase tracking-tighter">Personel</p>
      </div>
    ...
    <div class="bg-slate-800/50 p-6 rounded-2xl border border-gray-700 hover:border-gold/50 transition-all duration-300 group">
      ...
      <div class="flex items-baseline gap-2">
        ...
        <p class="text-xs text-gold font-medium uppercase tracking-tighter">Katalog</p>
      </div>
      <div class="mt-4 h-1 w-full bg-slate-900 rounded-full overflow-hidden">
         <div class="h-full bg-gold w-full opacity-20"></div>
      </div>
    ...
    <div class="bg-slate-800/50 p-6 rounded-2xl border border-gray-700 hover:border-gold/50 transition-all duration-300 group">
      ...
      <div class="flex items-baseline gap-2">
        ...
        <p class="text-xs text-gold font-medium uppercase tracking-tighter">Reservasi</p>
      </div>
      <div class="mt-4 h-1 w-full bg-slate-900 rounded-full overflow-hidden">
         <div class="h-full bg-gold w-full opacity-20"></div>
      </div>
