...
<div class="grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <div class="bg-slate-800 rounded-2xl overflow-hidden border border-gray-700 hover:border-gold transition group">
        <img src="{{ asset('storage/' . $barber->photo) }}" alt="{{ $barber->name }}" class="w-full h-64 object-top object-cover grayscale group-hover:grayscale-0 transition duration-500">
